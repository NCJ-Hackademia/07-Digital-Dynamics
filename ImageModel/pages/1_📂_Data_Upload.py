    ...
    if mode == "🖼️ Single Image Upload":
        ...
        if uploaded_image is not None:
            try:
                ...
                st.image(image_array, caption=uploaded_image.name, use_container_width=True)
                ...
                if image_data:
                    ...
                    for i, img_info in enumerate(image_data[:8]):
                        with preview_cols[i % 4]:
                            st.image(img_info['data'], caption=img_info['name'], use_container_width=True)
            ...
            if st.button("🔗 Load from URL"):
                if image_url:
                    try:
                        ...
                        st.image(image_array, caption="Loaded from URL", use_container_width=True)
            ...
            if st.button("🔗 Load from Base64"):
                if base64_data:
                    try:
                        ...
                        st.image(image_array, caption="Loaded from Base64", use_container_width=True)
